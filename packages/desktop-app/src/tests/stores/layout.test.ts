...
describe('Layout Store - Layout State Management', () => {
  ...
  describe('Initial State', () => {
    ...
    it('has correct initial navigation items', () => {
      ...
      // Items: daily-journal, search, settings
      ...
      //  recent ai-chat nodes; "favorites" and "conflicts" hidden until they are ready)
      expect(items.map((item) => item.id)).toEqual(['daily-journal', 'search', 'settings']);
